package exercise.packagecom.retrofittwitter;
...
public class MainActivity extends AppCompatActivity {
    ...
    private String credentials = Credentials.basic("eF8BEz1s8QqHSph6NWO5ypRjg", "lFyfJbXUSeeINkccZBCdy14cmTv9CYXYmVPkmLL772J8oGSfeK");
